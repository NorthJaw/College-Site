	...
	<body>
		...
		<div id="Signup" class="Register">
			...
			<form action="OpenPage.php" method="POST">
					...
					<h2>Signup</h2>
					Enter reg. no:<br>
					<input type="text" name="RegNo" class="PrimaryField"><br><br><br>
					Enter DOB:<br>
					<input type="text" name="DOB" class="PrimaryField"><br><br><br>
					Enter password:<br>
					<input type="password" name="Password" class="SecondaryField"><br><br><br>
					Re-Enter password:<br>
					<input type="password" name="RePassword" class="SecondaryField"><br><br><br>	
